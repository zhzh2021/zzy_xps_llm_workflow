"""
Stage 06 - MLP Classification.
Trains a classification MLP on feature-based datasets.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train MLP classification model.")
    ...
    model_cfg = cfg.get("models", {}).get("mlp_classification", {})
    ...
    run_name = f"mlp_classification_{run_id}"
    ...
    hidden_layers = model_cfg.get("hidden_layers", [512, 256, 128, 64])
    ...
    plot_training_history(history, plot_dir / "training_loss.png", "MLP Classification Loss")
    plot_confusion_matrix(y_test_enc, y_pred, plot_dir / "confusion_matrix.png", "MLP Classification")
